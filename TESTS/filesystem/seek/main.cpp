...
#define MBED_TEST_BLOCKDEVICE SDHIBlockDevice
#define MBED_TEST_BLOCKDEVICE_DECL SDHIBlockDevice bd(MBED_CONF_SDHI_CH);
#endif
...
#define INCLUDE(x,y) STRINGIZE(x.y)
...
struct dirent ent;
struct dirent *ed;
uint8_t buffer[MBED_CONF_SDHI_TEST_BUFFER];
