...
/* DEVICE_SDHI
 *  This symbol is defined in targets.json if the target has a SDHI interface, which is required for SDCard support.
 *
...
#if !(DEVICE_SDHI && ( defined(MBED_CONF_APP_FSFAT_SDCARD_INSTALLED) || (MBED_CONF_SDHI_FSFAT_SDCARD_INSTALLED)))
#error [NOT_SUPPORTED] DEVICE_SDHI need to be enabled for this test. SDcard need to be installed for this test.
#else
...
SDHIBlockDevice sd(MBED_CONF_SDHI_CH);
...
/// @endcond
#endif // !(DEVICE_SDHI && ( defined(MBED_CONF_APP_FSFAT_SDCARD_INSTALLED) || (MBED_CONF_SD_FSFAT_SDCARD_INSTALLED)))
